        ...
        <div class="conteudo">
            <nav class="modulos">
                ...
                <div class="modulo verde">
                    ...
                    <ul>
                        <li>
                            <a href="exercicio.php?dir=basic&file=hello">Hello PHP</a>
                        </li>
                        ...
                        <li>
                            <a href="exercicio.php?dir=basic&file=comentarios">Comentarios PHP</a>
                        </li>

                        <li>
                            <a href="exercicio.php?dir=basic&file=desafio">Desafio PHP</a>
                        </li>
                    </ul>
                </div>
            </nav>
